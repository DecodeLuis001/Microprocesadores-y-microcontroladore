 ...
 * Author: Luis A-Nuñez
 *
 * Created on 11 de abril de 2021, 05:24 PM
 */
//SENSOR DE TEMPERATURA POSITIVA Y NEGATIVA: VALORES APROXIMADOS.
...
void SensorLM35(void)
{
    ...
    if(temperatura > 99)
    {
        ...
        __delay_ms(100);    //Para mostrar una vez inicializada la LCD.
        printf(Valores);
        __delay_ms(100);    //Se actualizan los valores cada X mS.
    }
