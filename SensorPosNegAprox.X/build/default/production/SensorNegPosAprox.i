...
# 61 "SensorNegPosAprox.c" 2
# 83 "SensorNegPosAprox.c"
int ADC = 0;
float R_LM35, R_CAD;
...
void SensorLM35(void)
{
    ...
    {
        putcm(0x80);
        sprintf(Valores, " T = %3.4f %cC",temperatura, 0xDF);
    ...
    {
        putcm(0x80);
        sprintf(Valores, " T = %1.4f %cC",temperatura, 0xDF);
        _delay((unsigned long)((100)*(8000000/4000.0)));
        printf(Valores);
        _delay((unsigned long)((100)*(8000000/4000.0)));
    }
    ...
    {
        putcm(0x80);
        sprintf(Valores, " T = %2.4f %cC",temperatura, 0xDF);
        _delay((unsigned long)((100)*(8000000/4000.0)));
        printf(Valores);
        _delay((unsigned long)((100)*(8000000/4000.0)));
    }
