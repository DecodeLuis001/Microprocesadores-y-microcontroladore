//SENSOR DE TEMPERATURA POSITIVA: VALORES EXACTOS.
...
void LCD_COMANDOS(char comando) //Para poder invocar los comandos de la LCD.
{
    PIN_RS = 0;
...
void InicializaLCD(void)
{
    ...
    putcm(0x2C);    //Inicializa en 2 lineas 4x12
    __delay_ms(1);

    putcm(0x0C);    //Inicializa en 2 linea 3x4
    __delay_ms(1);

    putcm(0x06);    //Inicializa en 1 linea 1x6
    __delay_ms(1);
...
void SensorLM35(void)
{
    ...
    R_LM35 = 500.00001 / 1024;       //Formula suministraada en el datasheet del LM35.
...
void Alarma()
{
    ...
    {
        PORTCbits.RC6 = 0;  //No se enciende el led conectado a RC6.
        __delay_ms(300);
